...
% TENSORPROD - Multiply two or more arrays and sum over common dimensions.
%              The order of the arrays is significant if more than two of
%              them extend in the same direction.
%
